                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: LinearProgressIndicator(
                                                        ...
                                                        minHeight: 10,
                                                        borderRadius: BorderRadius.circular(10),
                                                        color: data.progress>0.7?const Color.fromARGB(255, 255, 0, 0):Colors.green,
                                                        ),
                                                    )
                                                  ],
                                                ),
                                                ...
                                                children: [
                                                  Text('₹${data.currentAmount}',
                                                      style: TextStyle(
                                                          ...
                                                          const Text(' / ',style: TextStyle(fontSize: 30,fontFamily:'texgyreadventor-regular',fontWeight: FontWeight.w100),),
